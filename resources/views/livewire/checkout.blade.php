                        ...
                        <div>
                            <div x-data="{ open: false }" class="relative w-full">
                                <div class="relative">
                                    ...
                                    <div wire:loading wire:target="region_selector.keyword" class="absolute right-3 top-3 animate-spin inline-block size-4 border-3 border-current border-t-transparent text-blue-600 rounded-full dark:text-blue-500" role="status" aria-label="loading">
                                    ...
                                    @foreach ($this->regions as $region )
                                        <li class="p-2 cursor-pointer hover:bg-gray-100">
                                            <label for="region-{{ $region->code }}" class="w-full inline-block cursor-pointer">
                                                <input id="region-{{ $region->code }}" value="{{ $region->code }}" wire:model.live="region_selector.region_selected" type="radio" class="sr-only" />
                                                {{ $region->label }}
                                            </label>
                                        </li> 
                                    @endforeach
                ...
                <div class="grid gap-5">
                    ...
                    <ul class="flex flex-col mt-3">
                        ...
                        <li
                            ...
                            <div class="flex items-center justify-between w-full">
                                <span>Total</span>
                                <span>{{ data_get($this->summeries, 'grand_total_formatted') }}</span>
                            </div>
                        </li>
                    </ul>
                    <!-- End List Group -->
